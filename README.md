...
that will act as the key for encrypting your plaintext. Each of the 25 letters must be
unique and one letter of the alphabet is omitted from the table (as there are 25 spots
...
rectangle in the key table. Note the relative position of the corners of this rectangle.
...
letter
2. If the letters appear on the same row of your table, replace them with the letters
...
the same row respectively but at the other pair of corners of the rectangle
...
the remaining cells with missed out letters in alphabetical order. Note that ‘i’ and ‘j’
takes the same cell.
...
# OUTPUT:
<img width="748" height="510" alt="image" src="https://github.com/user-attachments/assets/6af6330a-c079-4500-872d-925ecf7cd6ae" />

# RESULT:
 
Therefore, the code is executed successfully.
